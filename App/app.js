function accessAPI() {
  return fetch(
    "https://galvanize-cors.herokuapp.com/http://inqstatsapi.inqubu.com/?api_key=6e634b34088e8dc0&cmd=getWorldData&data=population"
  )
...
function giveDetailsToQueryString(event) {
  ...
  let newFetchURL =
    "https://galvanize-cors.herokuapp.com/http://inqstatsapi.inqubu.com?api_key=6e634b34088e8dc0&cmd=getWorldData&data=" +
    factURL;
